...
print_r($license_3s_cust_qty);
$license3scount=count($license_3s_cust_qty);
//echo $license3scount;
for($i=0;$i<$license3scount;$i++){
//    echo $i;
    echo $license_3s_cust_qty[$i][0]."<br>";
    echo $license_3s_cust_qty[$i][1]."<br>";
}
...
////    $pdf->SetFont('Arial','',8);
////    $pdf->Cell(40,5,'',0,0,'L');
////    $pdf->Cell(210,5,$license_2s_cust_qty[$i][0],0,0,'L');
////    $pdf->Cell(20,5,$license_2s_cust_qty[$i][1],0,1,'L');
////}
//$height_of_cell = 30; // mm
//$page_height = 286.93; // mm (portrait letter)
//$bottom_margin = 0; // mm
...
////    $pdf->SetFont('Arial','',8);
////    $pdf->Cell(40,5,'',0,0,'L');
////    $pdf->Cell(210,5,$license_3s_cust_qty[$i][0],0,0,'L');
////    $pdf->Cell(20,5,$license_3s_cust_qty[$i][1],0,1,'L');
////}
//$height_of_cell = 30; // mm
//$page_height = 286.93; // mm (portrait letter)
//$bottom_margin = 0; // mm
...
////    $pdf->SetFont('Arial','',8);
////    $pdf->Cell(40,5,'',0,0,'L');
////    $pdf->Cell(210,5,$Prof_cust_qty[$i][0],0,0,'L');
////    $pdf->Cell(20,5,$Prof_cust_qty[$i][1],0,1,'L');
////    }
//    $height_of_cell = 30; // mm
//$page_height = 286.93; // mm (portrait letter)
//$bottom_margin = 0; // mm
