...
<!--        <link rel="stylesheet" href="css/style-bg-other-pages.css">-->
    ...
    <body onresize="change_menus()"  oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
...
//            echo "entered";
            if($_SESSION["authentication"] == "passed"){ 
                ...
                //license cost values
               $license_cost=get_exchange_rate()*(calculate_3site_licence()+calculate_2site_licence()+master_server_license());
                $site_3s_discount=round(get_exchange_rate()*(calculate_3site_licence()*0.5));
...
//                $3_site_bunker_discount=round($3_site_bunker_discount);
                ...
                $professional_service_cost=round((calculate_prof_services()+master_server_prof())*get_exchange_rate());
                ...
                $product_training_cost=round(calculate_product_training());
                ...
                $totalValue=$final_cost_with_discount-round(get_exchange_rate()*(calculate_3site_licence()*0.5));
        ...
        <ul>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3"><b>Ref No :</b> <?php echo $_SESSION['ref_id']; ?></div>
                </div>
                <div class="row">
                    <div class="col-sm-3"></div>
                    <div class="col-sm-6"> </div>
                    <div class="col-sm-3"><b>Ver No :</b> <?php echo "1" ?></div>
                </div>
                <div class="row">
                    <div class="col-sm-3">Dear <?php echo $CustomerName ;?>,</div>
                    <div class="col-sm-6"></div>
                    <div class="col-sm-3"></div>
                </div>
                <br>
        ...
        <div class="container" id="license">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1" style="text-align:right">
                                <input class="form-control" type="text" tabindex="1" id="discount_license" placeholder="%" onblur="calculate_license_cost()" name="Discount_license" value="<?php echo $Discount_license ; ?>">
                            </div>
                            <div class="col-sm-2" style="text-align:right">
                            ...
                            <div class="col-sm-2" style="text-align:right">
                                ...
                                <input type="hidden" name="discount_3s" readonly value=" <?php echo $site_3s_discount ; ?>">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1" style="text-align:right">
                                <input class="form-control" type="text" tabindex="3" id="discount_prof_serv" name="Discount_prof_serv" placeholder="%" value="<?php echo $Discount_prof_serv;  ?>" onblur="calculate_professional_service_cost()">
                            </div>
                            <div class="col-sm-2" style="text-align:right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2" style="text-align:right">
                             ...
                             <div class="col-sm-1" style="text-align:right">
                                <input class="form-control" type="text" tabindex="4" id="discount_product_training" name="Discount_product_training" placeholder="%" value="<?php echo $Discount_product_training; ?>" onblur="calculate_product_training_cost()">
                            </div>
                            <div class="col-sm-2" style="text-align:right">
...
<!--
                            <div class="col-sm-1" style="text-align:right">
                                <input class="form-control" type="text" tabindex="4" id="avg_discount" readonly value="<?php //echo "-"; ?>">
...
-->
                   ...
                   <div class="panel panel-default">
                     <div class="panel-heading">
                         <label class="radio-inline">
                             <b><div class='tool' data-toggle='tooltip' data-placement='bottom' title=''> Annexure-1: Bill of Quantity </div></b></label></div>
                     <div class="panel-body"><?php include "../includes/annexure1_quote_without_values.php"; ?></div>
                   </div>
               </div>
             <?php  }else{
            ?>
            ...
            <div class="container form-group" style="padding-left:0px;padding-right:0px;">
               <div class="panel panel-default">
                 <div class="panel-heading">
                     <label class="radio-inline">
                       <input type="checkbox" class="license" id="annexure1" onclick="maskValues()">&nbsp;&nbsp;
                         <b><div class='tool' data-toggle='tooltip' data-placement='bottom' title='On Selecting, Annexure-1 will be printed in PDF too'> Annexure-1: Bill of Quantity </div></b></label></div>
                 <div class="panel-body collapse" id="billQuantity" style="display: block;"><?php include "../includes/annexure1_quote.php"; ?></div>
                 <div class="panel-body collapse" id="billQuantity1" style="display: block;"><?php include "../includes/annexure1_quote_without_values.php"; ?></div>
               </div>
           </div>
        ...
        <div class="container">
            ...
            <div class="col-sm-7">
                <span style="font-size:12px;"><b>Note:</b><br>The Quote is already saved as Draft.<br>Editing is not possible once the finalize button is clicked</span>
            </div>
            
            <div class="col-sm-5">
                <input type="hidden" readonly id="annexure_1" name="Annexure_1">
                    <input type="submit" id="finalize" class="btn btn-lg btn-success pull-right" name="finalize" value="Finalize">
<!--                    <input type="submit" id="onlysave" class="btn btn-lg btn-success pull-right" name="save" value="SAVE">-->
                    <br> </div>
        </div>
        </form>
