...
<!--                        INCLUDE BASE PRICE NAV LINKS-->
                        ...
                        <div class="row">
                            <div class="col-sm-12 main_content">
                                ...
                                <?php
                                    $rows=no_of_rows_base_prices("USA/Europe");
                                    for($i=1; $i<=$rows; $i++){
                                        if (!empty($_POST["BasePricesButton$i"])) {
                                            $result=update_base_price_values($i, "USA_Europe", $_POST["BasePrice$i"]);
                                            echo "<p style=\"color:GREEN;\">".$result."</p>";
//                                            echo "No Errors";
                                        }
                                    }
                                ?>
                                <h2>Base Prices Table (USA/Europe)</h2>
                                ...
                                <table style="font-size:12px;">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            $app_id=$i; 
                                            $details=gather_base_prices_values($i, "USA_Europe");
