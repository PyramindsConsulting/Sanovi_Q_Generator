                    ...
                    <div class="col-sm-8 col-md-9 breadcrumbs_div">
                        ...
                        <div class="row">
                            <div class="col-sm-12 main_content">
                                ...
                                <?php
                                    for($i=1; $i<=4; $i++){
                                        if (!empty($_POST["LearningFactorButton$i"])) {
                                            $result=update_learning_factor_values($i,$_POST["SimpleApp$i"], $_POST["ComplexApp$i"]);
                                            echo "<p style=\"color:GREEN;\">".$result."</p>";
                                        }
                                    }
                                ?>
                                <h2>Modify Learning Factor Table</h2>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            $app_id=$i; 
                                            $details=gather_learning_factor_values($app_id);
                                        ?>
                                        <form id="form<?php echo $i; ?>" method="post" onsubmit="return confirm('Are you sure you want to make this change?');">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="SimpleApp<?php echo $i; ?>" value="<?php echo $details["simple_app"]; ?>" type="text" readonly="true" ondblclick="this.readOnly='';" onblur="this.readOnly='true';" onchange="document.getElementById('LFB<?php echo $i ?>').removeAttribute('disabled'); document.getElementById('LFB<?php echo $i ?>').style.backgroundColor='#b7fcae'" title="Double Click to Edit" size="14">
                                                    </td>
                                                    <td>
                                                        <input name="ComplexApp<?php echo $i; ?>" value="<?php echo $details["complex_app"]; ?>" type="text" readonly="true" ondblclick="this.readOnly='';" onblur="this.readOnly='true';" onchange="document.getElementById('LFB<?php echo $i ?>').removeAttribute('disabled'); document.getElementById('LFB<?php echo $i ?>').style.backgroundColor='#b7fcae'" title="Double Click to Edit" size="14">
                                                    </td>
                                                    <td>
                                                        <input id="LFB<?php echo $i; ?>" name="LearningFactorButton<?php echo $i; ?>" type="submit" value="Save" disabled>
                                                    </td>
                                                </tr>
                                        </form>
                                        <?php } ?>
