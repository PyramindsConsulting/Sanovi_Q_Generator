...
<!--                        INCLUDE BASE PRICE NAV LINKS-->
                        ...
                        <div class="row">
                            <div class="col-sm-12 main_content">
                                ...
                                <?php
                                    $rows=no_of_rows_base_prices("Rest of World");
                                    for($i=1; $i<=$rows; $i++){
                                        if (!empty($_POST["BasePricesButton$i"])) {
                                            $result=update_base_price_values($i, "Rest_of_World", $_POST["BasePrice$i"]);
                                            echo "<p style=\"color:GREEN;\">".$result."</p>";
                                        }
                                    }
                                ?>
                                <h2>Base Prices Table(Rest of World)</h2>
                                ...
                                <table style="font-size:12px;">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            $app_id=$i; 
                                            $details=gather_base_prices_values($i, "Rest_of_World");
