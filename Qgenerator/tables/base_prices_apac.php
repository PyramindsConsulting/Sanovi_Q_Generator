...
<!--                        INCLUDE BASE PRICE NAV LINKS-->
                        ...
                        <div class="row">
                            <div class="col-sm-12 main_content">
                                ...
                                <?php
                                    $rows=no_of_rows_base_prices("APAC");
                                    for($i=1; $i<=$rows; $i++){
                                        if (!empty($_POST["BasePricesButton$i"])) {
//                                            $result=update_general_discounts_values($i, $_POST["DiscPercentage$i"]);
                                            $result=update_base_price_values($i, "APAC", $_POST["BasePrice$i"]);
                                            echo "<p style=\"color:GREEN;\">".$result."</p>";
                                        }
                                    }
                                ?>
                                <h2>Base Prices Table (APAC)</h2>
                                ...
                                <table style="font-size:12px;">
                                    ...
                                    <tbody>
                                        ...
                                        <?php 
                                            $app_id=$i; 
                                            $details=gather_base_prices_values($i, "APAC");
                                        ...
                                        ?>
                                            <form id="form<?php echo $i; ?>" method="post" onsubmit="return confirm('Are you sure you want to make this change?');">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input name="PartNo<?php echo $i; ?>" value="<?php echo $details["part_number"]; ?>" type="text" readonly="true" onblur="this.readOnly='true';" onchange="document.getElementById('BPB<?php echo $i ?>').removeAttribute('disabled'); document.getElementById('BPB<?php echo $i ?>').style.backgroundColor='#b7fcae'"  size="30" >
                                                    </td>
                                                    <td>
                                                        <input name="PartDesc<?php echo $i; ?>" value="<?php echo $details["part_desc"]; ?>" type="text" readonly="true" onblur="this.readOnly='true';" onchange="document.getElementById('BPB<?php echo $i ?>').removeAttribute('disabled'); document.getElementById('BPB<?php echo $i ?>').style.backgroundColor='#b7fcae'"  size="110" wrap="true">
                                                    </td>
                                                    <td>
                                                        <input name="Module<?php echo $i; ?>" value="<?php echo $details["product_module"]; ?>" type="text" readonly="true" onblur="this.readOnly='true';" onchange="document.getElementById('BPB<?php echo $i ?>').removeAttribute('disabled'); document.getElementById('BPB<?php echo $i ?>').style.backgroundColor='#b7fcae'" size="20">
                                                    </td>
                                                    <td>
