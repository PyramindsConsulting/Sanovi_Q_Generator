...
$pdf->Cell(23,5,$lht_data["trainingCost"],0,0,'R');
//$pdf->Cell(25,5,$lht_data["discountPercentageOnTraining"],0,0,'R');
$pdf->Cell(36,5,'-',0,0,'R');
$pdf->Cell(42,5,$lht_data["finalTrainingCost"],0,0,'R');
$pdf->ln();
$pdf->ln();
$pdf->SetFont('Arial','B',10);
...
$t=time();
$Quote_Name="temp/Sanovi_Quote".$t.".pdf";

$pdfdoc = $pdf->Output($Quote_Name, 'F');
header('location:mail_quote.php?Quote_Name='.$Quote_Name.'&emailid='.$emailid);
