...
$sap_hana_data_2s=$_POST['sap_hana_data_2S'];
$sap_hana_nodes_2s=$_POST['sap_hana_nodes_2S'];
...
$sap_hana_data_3s=$_POST['sap_hana_data_3S'];
$sap_hana_nodes_3s=$_POST['sap_hana_nodes_3S'];
...
$prof_services_sap_hana_data=$_POST['Prof_services_sap_hana_data'];
$prof_services_sap_hana_node=$_POST['Prof_services_sap_hana_node'];
