                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <!--Approve Quote ICON -->
                                        <a onclick="return confirm('Are you sure to Finalize the Quote !');" href="quote_approve.php?refId=<?php echo $refId."&verId=".$j;?>" data-toggle="tooltip" data-placement="top" title="Approve Quote"><span class="glyphicon glyphicon-ok"> </span></a>
                                        
                                        <!--View Quote ICON -->
                                        <a href="pdf/html_view_quote.php?refId=<?php echo $refId."&verId=".$j;?>" target="_blank" data-toggle="tooltip" data-placement="top" title="View Quote"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                                        
                                        <!--View PDF ICON -->
                                        <a href="pdf/view_quote.php?refId=<?php echo $refId."&verId=".$j;?>" target="_blank" data-toggle="tooltip" data-placement="top" title="View Quote"><span class="glyphicon glyphicon-eye-open"> </span></a>
